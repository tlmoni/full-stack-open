describe("Blogs app", function() {
  ...
  describe("Blogs are ordered by number of likes", function() {
    beforeEach(function() {
      cy.login(user)
      cy.addBlog({ title: "test1", author: "Noot", url: "http://example.com/test1" })
      cy.contains("test1 Noot").parent().as("blog1")
      cy.addBlog({ title: "test2", author: "Doot", url: "http://example.com/test2" })
      cy.contains("test2 Doot").parent().as("blog2")
      cy.addBlog({ title: "test3", author: "Groot", url: "http://example.com/test3" })
